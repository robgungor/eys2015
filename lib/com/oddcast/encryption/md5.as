/**
 * I took this class from the as2 classes and updated it for as3
 * For some reason the built-in adobe MD5 class in as3 (com.adobe.crypto.MD5) was hashing foreign
 * characters differently from this class, breaking TTS for asian languages.  This is the best fix
...
package com.oddcast.encryption {
	public class md5 {
		...
		*/
		public function md5($b64pad:String = "", $chrsz:Number = 8) {
			b64pad = $b64pad;
			chrsz = $chrsz;
		}
